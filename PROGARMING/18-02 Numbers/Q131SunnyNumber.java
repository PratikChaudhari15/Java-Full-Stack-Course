...
{	//A Sunny number is a number where the next consecutive number 	is
 a perfect square. In other words, when you add 1 to a Sunny number, the result is a perfect square
